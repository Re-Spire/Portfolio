...
<template>
        <form @submit.prevent="onSubmit" id="projets" ref="projets"></form>
  <div id="project">
      ...
      <article>
        ...
        <ul ref="projectList">
            ...
            <button @click="openModal">
              <img id="CV" src="../assets/img/cdc.png" alt="CDC" />
            </button>
            <ModalComponent :isOpen="isModalOpened">
              ...
              <template #content>
                <p><a href="https://online.fliphtml5.com/pepxm/rgyd/" target="_blank" ref="CDC">Lien vers mon cahier des charges</a></p>
                <ul>
            <li id="HTML">HTML
